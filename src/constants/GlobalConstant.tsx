...
export const LOGIN_SCREEN = {
    ...
    MESSAGE_PERMISSION: {
        TITLE: "SistemaUV requiere uso del bluetooth",
        MESSAGE: "SistemaUV necesita acceso a las funcionalidades Bluetooth",
        BUTTON_POSSITIVE: "ACEPTAR",
        BUTTON_NEGATIVE: "No permito el uso del bluetooth para sistema uv",
    },
    TOAST_SUCCESS: 'success',
    TOAST_ERROR: 'error',
    TOAST_REGISTER: {
    ...
    TOAST_PERMISSION_DENIED: {
        TITLE: '¡Permiso bluetooth denegado!',
        MESSAGE: 'Es necesario habilitar el uso del bluetooth para el SistemaUV.'
    },
    TOAST_PERMISSION_ENABLED: {
        TITLE: '¡Habilitar permiso bluetooth!',
        MESSAGE: 'Para continuar es necesario habilitar el uso del bluetooth para el SistemaUV.'
    },
    ALERT_PERMISSION_BLUETOOTH: {
        TITLE: '¡Habilitar permiso!',
        MESSAGE: 'Habilite el permiso de bluetooth para utilizar el app',
